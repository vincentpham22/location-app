    ...
    surface, bedrooms, bathrooms, hasPool, hasKitchen }) => {
        return (
            <div className='max-w-[800px] mx-auto p-6 bg-white shadow-lg rounded-md'>
                <h2 className='text-2xl font-semibold mb-4'>Infomations</h2>
